...
|-------|-----------|-------------------|
| [ArborBasin](ArborBasin/) | The CADSWES RiverWare training model: 41 objects, two basins joined by a transbasin diversion, a five-reservoir power cascade, irrigation districts, and a groundwater complex. Included with attribution to [CADSWES](https://cadswes.colorado.edu/), University of Colorado Boulder. | [Narrative](ArborBasin/ArborBasin_explained.md) · [Dashboard](https://jrkasprzyk.github.io/RiverWare-AI-Tools/examples/ArborBasin/ArborBasin_dashboard.html) · [Rule case study](ArborBasin/ArborBasin_rule_case_study.md) · [Annotation review](ArborBasin/ArborBasin_annotations.md) |
