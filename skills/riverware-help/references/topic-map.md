...
| Comparing RPL Sets / UUIDs | `RPL/RPLUserInterface.3.06.html` | RPL Set Comparison Tool; UUIDs (introduced 7.5) track set items so compare and copy-property match by UUID not name; sets diverged pre-7.5 may not compare |
